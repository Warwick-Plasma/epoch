...
Stitched_Magnitude_Reader::Stitched_Magnitude_Reader(BlockHandler *Handler,
...
void
Stitched_Magnitude_Reader::PopulateDatabaseMetaData(avtDatabaseMetaData *md)
{
    ...
    avtScalarMetaData *smd = new avtScalarMetaData(Composite, MeshComposite,
        cent);
