...
COMMON BlockTypes,TYPE_ADDITIONAL, TYPE_MESH, TYPE_MESH_VARIABLE, TYPE_PARTICLE_VARIABLE
...
;Can't load particle variables yet, so hide
IF (test EQ TYPE_PARTICLE_VARIABLE) THEN RETURN,1
