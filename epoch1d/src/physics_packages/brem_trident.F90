...
CONTAINS
      ...
      DO ispecies = 1, n_species
        ...
        IF (species_list(ispecies)%species_type == c_species_id_electron) THEN
          ...
          DO WHILE(ASSOCIATED(electron))
            ...
            part_x = electron%part_pos - x_grid_min_local
            CALL grid_centred_var_at_particle_bt(part_x, part_ni, &
  ...
  SUBROUTINE grid_centred_var_at_particle_bt(part_x, part_var, &
      grid_var)
