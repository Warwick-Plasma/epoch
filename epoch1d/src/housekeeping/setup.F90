      ...
      CASE(c_type_mesh_variable)
        ...
        CASE(c_var_cartesian)
          ...
          IF (str_cmp(name(1:2), "Ex")) &
              CALL cfd_get_1d_cartesian_variable_parallel(ex(1:nx), &
                  subtype_field)

          IF (str_cmp(name(1:2), "Ey")) &
              CALL cfd_get_1d_cartesian_variable_parallel(ey(1:nx), &
                  subtype_field)

          IF (str_cmp(name(1:2), "Ez")) &
              CALL cfd_get_1d_cartesian_variable_parallel(ez(1:nx), &
                  subtype_field)

          IF (str_cmp(name(1:2), "Bx")) &
              CALL cfd_get_1d_cartesian_variable_parallel(bx(1:nx), &
                  subtype_field)

          IF (str_cmp(name(1:2), "By")) &
              CALL cfd_get_1d_cartesian_variable_parallel(by(1:nx), &
                  subtype_field)

          IF (str_cmp(name(1:2), "Bz")) &
              CALL cfd_get_1d_cartesian_variable_parallel(bz(1:nx), &
                  subtype_field)

          IF (str_cmp(name(1:2), "Jx")) &
              CALL cfd_get_1d_cartesian_variable_parallel(jx(1:nx), &
                  subtype_field)

          IF (str_cmp(name(1:2), "Jy")) &
              CALL cfd_get_1d_cartesian_variable_parallel(jy(1:nx), &
                  subtype_field)

          IF (str_cmp(name(1:2), "Jz")) &
              CALL cfd_get_1d_cartesian_variable_parallel(jz(1:nx), &
                  subtype_field)
