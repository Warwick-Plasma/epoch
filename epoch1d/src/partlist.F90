...
CONTAINS
  ...
  SUBROUTINE Create_Empty_PartList(PartList)
    ...
    TYPE(ParticlePointer),INTENT(INOUT) :: PartList
  ...
  SUBROUTINE Create_Unsafe_PartList(PartList,aParticle,n_elements)
    ...
    TYPE(ParticlePointer),INTENT(INOUT) :: PartList
    TYPE(Particle), POINTER, INTENT(IN) :: aParticle
  ...
  SUBROUTINE Create_Unsafe_PartList_By_Tail(PartList,Head,Tail)
    ...
    TYPE(ParticlePointer),INTENT(INOUT) :: PartList
    TYPE(Particle), POINTER, INTENT(IN) :: Head,Tail
    TYPE(Particle), POINTER :: Current
    INTEGER(KIND=8) :: ipart
  ...
  SUBROUTINE Copy_PartList(PartList1,PartList2)
    ...
    TYPE(ParticlePointer), INTENT(INOUT) :: PartList1, PartList2
  ...
  SUBROUTINE Append_PartList(Head,Tail)
    ...
    TYPE(ParticlePointer), INTENT(INOUT) :: Head, Tail
  ...
  SUBROUTINE Add_Particle_To_PartList(PartList,NewParticle)
    ...
    TYPE(ParticlePointer), INTENT(INOUT) :: PartList
    TYPE(Particle), POINTER, INTENT(INOUT) :: NewParticle
  ...
  SUBROUTINE Remove_Particle_From_PartList(PartList,aParticle)
    ...
    TYPE(ParticlePointer), INTENT(INOUT) :: PartList
    TYPE(Particle), POINTER, INTENT(INOUT) :: aParticle
  ...
  SUBROUTINE Pack_Particle(Data,aParticle)
    ...
    cpos=cpos+3
    Data(cpos)=REAL(aParticle%part_species,num)+0.1
    cpos=cpos+1
#ifdef PER_PARTICLE_WEIGHT
...
!!$    PRINT *,"In Pack",rank,aParticle%Part_Pos
  ...
  SUBROUTINE Unpack_Particle(Data,aParticle)
    ...
    cpos=cpos+3
    aParticle%Part_Species=INT(Data(cpos))
    cpos=cpos+1
#ifdef PER_PARTICLE_WEIGHT
...
!!$    PRINT *,"In Unpack",rank,aParticle%Part_Species
  ...
  FUNCTION Compare_Particles(Part1,Part2)
    ...
    IF (Part1%Part_Pos      .NE. Part2%Part_Pos     ) Compare_Particles=.FALSE.
    IF (MAXVAL(ABS(Part1%Part_P - Part2%Part_P)) .NE. 0.0_num    ) Compare_Particles=.FALSE.
    IF (Part1%Part_Species  .NE. Part2%Part_Species ) Compare_Particles=.FALSE.
...
!!$    ENDDO
  ...
  SUBROUTINE PartList_Recv(PartList,Src)
    ...
    TYPE(ParticlePointer) :: PartListTemp
...
!!$    ENDDO
  ...
  SUBROUTINE PartList_SendRecv(PartList_Send,PartList_Recv,Dest,Src)
    ...
    TYPE(ParticlePointer),INTENT(INOUT) :: PartList_Send, PartList_Recv
