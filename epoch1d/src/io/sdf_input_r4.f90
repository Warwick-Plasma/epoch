...
CONTAINS
  ...
  SUBROUTINE read_header_r4(h, step, time, code_name, code_io_version, &
  ...
  END SUBROUTINE read_header_r4



  SUBROUTINE read_constant_real_r4(h, value)
  ...
  SUBROUTINE read_1d_array_real_r4(h, values)
  ...
  END SUBROUTINE read_1d_array_real_r4



  SUBROUTINE read_2d_array_real_r4(h, values)
  ...
  END SUBROUTINE read_2d_array_real_r4



  SUBROUTINE read_3d_array_real_r4(h, values)
  ...
  END SUBROUTINE read_3d_array_real_r4

END MODULE sdf_input_r4
