...
if (exist('0002.sdf') ~=2)
    ...
    epoch_px = GetVariableSDF('0002.sdf', 'electron_probe.Px.data');
    epoch_py = GetVariableSDF('0002.sdf', 'electron_probe.Py.data');
    epoch_pz = GetVariableSDF('0002.sdf', 'electron_probe.Pz.data');
end
