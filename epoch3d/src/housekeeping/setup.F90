    ...
    DO ix = 1, nblocks
      ...
      CASE(c_type_mesh_variable)
        ...
        CASE(c_var_cartesian)
          ...
          IF (str_cmp(name, "Ex")) &
              CALL cfd_get_3d_cartesian_variable_parallel(ex, subtype_field, &
                  subarray_field)

          IF (str_cmp(name, "Ey")) &
              CALL cfd_get_3d_cartesian_variable_parallel(ey, subtype_field, &
                  subarray_field)

          IF (str_cmp(name, "Ez")) &
              CALL cfd_get_3d_cartesian_variable_parallel(ez, subtype_field, &
                  subarray_field)

          IF (str_cmp(name, "Bx")) &
              CALL cfd_get_3d_cartesian_variable_parallel(bx, subtype_field, &
                  subarray_field)

          IF (str_cmp(name, "By")) &
              CALL cfd_get_3d_cartesian_variable_parallel(by, subtype_field, &
                  subarray_field)

          IF (str_cmp(name, "Bz")) &
              CALL cfd_get_3d_cartesian_variable_parallel(bz, subtype_field, &
                  subarray_field)

          IF (str_cmp(name, "Jx")) &
              CALL cfd_get_3d_cartesian_variable_parallel(jx, subtype_field, &
                  subarray_field)

          IF (str_cmp(name, "Jy")) &
              CALL cfd_get_3d_cartesian_variable_parallel(jy, subtype_field, &
                  subarray_field)

          IF (str_cmp(name, "Jz")) &
              CALL cfd_get_3d_cartesian_variable_parallel(jz, subtype_field, &
                  subarray_field)
