...
CONTAINS
  ...
  FUNCTION create_current_field_subtype()
    ...
    create_current_field_subtype = create_field_subtype(nx, ny, nz, cell_x_start(coordinates(3)+1), cell_y_start(coordinates(2)+1), cell_z_start(coordinates(1)+1))
  ...
  FUNCTION create_field_subtype(nx_local, ny_local, nz_local, cell_start_x_local, cell_start_y_local, cell_start_z_local)
    ...
    create_field_subtype = create_3d_array_subtype((/nx_local, ny_local, nz_local/), (/nx_global, ny_global, nz_global/), (/cell_start_x_local, cell_start_y_local, cell_start_z_local/))
