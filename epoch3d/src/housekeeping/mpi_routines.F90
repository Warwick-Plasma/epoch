...
CONTAINS
  ...
  SUBROUTINE setup_communicator
    ...
    IF (bc_x_min_field  .NE. c_bc_periodic &
        ...
        .OR. bc_x_max_particle .NE. c_bc_periodic) periods(3) = .FALSE.
    IF (bc_y_min_field  .NE. c_bc_periodic &
        .OR. bc_y_max_field .NE. c_bc_periodic &
        .OR. bc_y_min_particle .NE. c_bc_periodic &
        .OR. bc_y_max_particle .NE. c_bc_periodic) periods(2) = .FALSE.
    IF (bc_z_min_field  .NE. c_bc_periodic &
        .OR. bc_z_max_field .NE. c_bc_periodic &
        .OR. bc_z_min_particle .NE. c_bc_periodic &
        .OR. bc_z_max_particle .NE. c_bc_periodic) periods(1) = .FALSE.
