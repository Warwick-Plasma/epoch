...
MODULE shared_data
  ...
  INTEGER :: xbc_right_particle, xbc_left_particle , ybc_up_particle, ybc_down_particle , zbc_front_particle, zbc_back_particle
  INTEGER :: xbc_right_field, xbc_left_field , ybc_up_field, ybc_down_field , zbc_front_field, zbc_back_field
  ...
  INTEGER, DIMENSION(:), ALLOCATABLE :: cell_x_start, cell_x_end, cell_y_start, cell_y_end , cell_z_start, cell_z_end
