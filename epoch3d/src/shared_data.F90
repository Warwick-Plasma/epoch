...
MODULE constants
  ...
  INTEGER, PARAMETER :: BD_LEFT=1, BD_RIGHT=2, BD_UP=3, BD_DOWN=4, BD_FRONT=5, BD_BACK=6
  ...
  !Load balance codes
  INTEGER,PARAMETER :: LB_X=1, LB_Y=2, LB_Z=4, LB_AUTO=8, LB_ALL=LB_X+LB_Y+LB_Z
  ...
  INTEGER,PARAMETER :: EntryLength=400
...
MODULE shared_parser_data
  ...
  INTEGER,PARAMETER :: CONST_DIR_PY=53, CONST_DIR_PZ=54, CONST_R_XY=55, CONST_R_YZ=56, CONST_R_XZ=57
  ...
  INTEGER,PARAMETER :: FUNC_GAUSS=33, FUNC_ABS=34
