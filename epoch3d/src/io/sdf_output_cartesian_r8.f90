...
CONTAINS
  ...
  SUBROUTINE write_1d_float_gen_r8(h, id, name, units, ndims, dims, sz, &
  ...
  SUBROUTINE write_2d_float_gen_r8(h, id, name, units, ndims, dims, sz, &
      stagger, mesh_id, variable, distribution, subarray, convert_in, mult)
  ...
  SUBROUTINE write_3d_float_gen_r8(h, id, name, units, ndims, dims, sz, &
      stagger, mesh_id, variable, distribution, subarray, convert_in, mult)
  ...
  SUBROUTINE write_4d_float_gen_r8(h, id, name, units, ndims, dims, sz, &
      stagger, mesh_id, variable, distribution, subarray, convert_in, mult)
  ...
  SUBROUTINE write_1d_float_r8(h, id, name, units, dims, stagger, mesh_id, &
    ...
    CALL write_1d_float_gen_r8(h, id, name, units, ndims, dims, sz, stagger, &
  ...
  SUBROUTINE write_2d_float_r8(h, id, name, units, dims, stagger, mesh_id, &
    ...
    CALL write_2d_float_gen_r8(h, id, name, units, ndims, dims, sz, stagger, &
        mesh_id, variable, distribution, subarray, convert, mult)
  ...
  SUBROUTINE write_3d_float_r8(h, id, name, units, dims, stagger, mesh_id, &
    ...
    CALL write_3d_float_gen_r8(h, id, name, units, ndims, dims, sz, stagger, &
        mesh_id, variable, distribution, subarray, convert, mult)
  ...
  SUBROUTINE write_3d_var_first_r8(h, id, name, units, dims, sz, stagger, &
    ...
    CALL write_4d_float_gen_r8(h, id, name, units, ndims, dims, sz, stagger, &
