...
SAVE
  ...
  INTEGER,PARAMETER :: BoundaryBlockElements=6
  LOGICAL, DIMENSION(BoundaryBlockElements)  :: BoundaryBlockDone
  CHARACTER(len=30),DIMENSION(BoundaryBlockElements) :: BoundaryBlockName=(/"xbc_left","xbc_right","ybc_up","ybc_down","zbc_front","zbc_back"/)
