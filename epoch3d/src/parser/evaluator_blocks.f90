...
CONTAINS
  ...
  SUBROUTINE DoOperator(opcode,ix,iy,iz,err)
  ...
  SUBROUTINE DoConstant(opcode,ix,iy,iz,err)
    ...
    IF (opcode .GE. CONSTANT_CUSTOM_LOWBOUND) THEN
       ...
       Result = CustomConstant(opcode,ix,iy,iz,err)    
    ...
    IF (opcode .EQ. CONST_LZ) THEN
       CALL PushOnEval(length_z)
       RETURN
    ENDIF
    ...
    IF (opcode .EQ. CONST_Z) THEN
       CALL PushOnEval(z(iz)+dz/2.0_num)
       RETURN
    ENDIF
    ...
    IF (opcode .EQ. CONST_START_Z) THEN
       CALL PushOnEval(z_start)
       RETURN
    ENDIF
    ...
    IF (opcode .EQ. CONST_END_Z) THEN
       CALL PushOnEval(z_end)
       RETURN
    ENDIF
    ...
    IF (opcode .EQ. CONST_IZ) THEN
       CALL PushOnEval(REAL(iz,num))
       RETURN 
    ENDIF
    ...
    IF (opcode .EQ. CONST_R_XY) THEN
       CALL PushOnEval(SQRT(x(ix)**2+y(iy)**2))
       RETURN
    ENDIF

    IF (opcode .EQ. CONST_R_XZ) THEN
       CALL PushOnEval(SQRT(x(ix)**2+z(iz)**2))
       RETURN
    ENDIF

    IF (opcode .EQ. CONST_R_YZ) THEN
       CALL PushOnEval(SQRT(y(iy)**2+z(iz)**2))
       RETURN
    ENDIF

  END SUBROUTINE DoConstant

  SUBROUTINE DoFunctions(opcode,ix,iy,iz,err)
    ...
    IF (opcode .EQ. FUNC_RHO) THEN
       CALL GetValues(1,Values)
       CALL PushOnEval(InitialConditions(NINT(Values(1)))%rho(ix,iy,iz))
       RETURN
    ENDIF
    IF (opcode .EQ. FUNC_TEMPX) THEN
       CALL GetValues(1,Values)
       CALL PushOnEval(InitialConditions(NINT(Values(1)))%temp(ix,iy,iz,1))
       RETURN
    ENDIF
    IF (opcode .EQ. FUNC_TEMPY) THEN
       CALL GetValues(1,Values)
       CALL PushOnEval(InitialConditions(NINT(Values(1)))%temp(ix,iy,iz,2))
       RETURN
    ENDIF
    IF (opcode .EQ. FUNC_TEMPZ) THEN
       CALL GetValues(1,Values)
       CALL PushOnEval(InitialConditions(NINT(Values(1)))%temp(ix,iy,iz,3))
       RETURN
    ENDIF
    ...
    IF (opcode .EQ. FUNC_EX) THEN
       CALL GetValues(3,Values)
       CALL PushOnEval(Ex(NINT(Values(1)),NINT(Values(2)),NINT(Values(3))))
       RETURN
    ENDIF
    IF (opcode .EQ. FUNC_EY) THEN
       CALL GetValues(3,Values)
       CALL PushOnEval(Ey(NINT(Values(1)),NINT(Values(2)),NINT(Values(3))))
       RETURN
    ENDIF
    IF (opcode .EQ. FUNC_EZ) THEN
       CALL GetValues(3,Values)
       CALL PushOnEval(Ez(NINT(Values(1)),NINT(Values(2)),NINT(Values(3))))
       RETURN
    ENDIF
    IF (opcode .EQ. FUNC_BX) THEN
       CALL GetValues(3,Values)
       CALL PushOnEval(BX(NINT(Values(1)),NINT(Values(2)),NINT(Values(3))))
       RETURN
    ENDIF
    IF (opcode .EQ. FUNC_BY) THEN
       CALL GetValues(3,Values)
       CALL PushOnEval(By(NINT(Values(1)),NINT(Values(2)),NINT(Values(3))))
       RETURN
    ENDIF
    IF (opcode .EQ. FUNC_BZ) THEN
       CALL GetValues(3,Values)
       CALL PushOnEval(Bz(NINT(Values(1)),NINT(Values(2)),NINT(Values(3))))
       RETURN
    ENDIF
    ...
    Result = CustomFunction(opcode,ix,iy,iz,err)
