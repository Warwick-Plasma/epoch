...
CONTAINS
  ...
  FUNCTION AsConstant(name)
    ...
    IF (StrCmp(name,"z"))  AsConstant=CONST_Z
    IF (StrCmp(name,"lengthx") .OR. StrCmp(name,"length_x")) AsConstant=CONST_LX
    IF (StrCmp(name,"lengthy") .OR. StrCmp(name,"length_y")) AsConstant=CONST_LY
    IF (StrCmp(name,"lengthz") .OR. StrCmp(name,"length_z")) AsConstant=CONST_LZ
    IF (StrCmp(name,"dx")) AsConstant=CONST_DX
    IF (StrCmp(name,"dy")) AsConstant=CONST_DY
    IF (StrCmp(name,"dy")) AsConstant=CONST_DZ
    IF (StrCmp(name,"x_start")) AsConstant=CONST_START_X
    IF (StrCmp(name,"y_start")) AsConstant=CONST_START_Y
    IF (StrCmp(name,"y_start")) AsConstant=CONST_START_Z
    IF (StrCmp(name,"x_end")) AsConstant=CONST_END_X
    IF (StrCmp(name,"y_end")) AsConstant=CONST_END_Y
    IF (StrCmp(name,"z_end")) AsConstant=CONST_END_Z
    IF (StrCmp(name,"ix")) AsConstant=CONST_IX
    IF (StrCmp(name,"iy")) AsConstant=CONST_IY
    IF (StrCmp(name,"iy")) AsConstant=CONST_IZ
    ...
    IF (StrCmp(name,"dir_y")) AsConstant=CONST_DIR_Y
    IF (StrCmp(name,"dir_z")) AsConstant=CONST_DIR_Z
    ...
    IF (StrCmp(name,"r_xy")) AsConstant=CONST_R_XY
    IF (StrCmp(name,"r_yz")) AsConstant=CONST_R_YZ
    IF (StrCmp(name,"r_xz")) AsConstant=CONST_R_XZ
