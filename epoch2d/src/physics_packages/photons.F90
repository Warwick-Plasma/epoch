...
CONTAINS
  ...
  SUBROUTINE qed_update_optical_depth()
    ...
    REAL(num) :: part_x, part_y, part_px, part_py, part_pz,&
        eta, chi_val
    ...
    DO ispecies=1,n_species
      ...
      IF(species_list(ispecies)%species_type .EQ. &
        ...
        DO WHILE(ASSOCIATED(current))
          ...
          eta = calculate_eta(part_x,part_y,part_px,part_py,part_pz)
      ...
      IF(species_list(ispecies)%species_type .EQ. &
        ...
        IF (produce_pairs) THEN
          ...
          DO WHILE(ASSOCIATED(current))
            ...
            chi_val = calculate_chi(part_x,part_y,part_vx,part_vy,&
                part_vz,part_E)
  ...
  FUNCTION calculate_eta(part_x,part_y,part_px,part_py,part_pz)

    REAL(num) :: calculate_eta
    REAL(num) :: B_Bs(1:3), E_Es(1:3)  !, w(0:3)
    REAL(num) :: part_x, part_y, E_at_part(1:3), B_at_part(1:3)
  ...
  FUNCTION calculate_chi(part_x,part_y,part_vx,part_vy,part_vz,part_E)
