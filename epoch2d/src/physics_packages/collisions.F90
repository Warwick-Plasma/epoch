...
CONTAINS
  ...
  SUBROUTINE particle_collisions
    ...
    ALLOCATE(idens(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(jdens(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(itemp(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(jtemp(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(log_lambda(-ng+1:nx+ng,-ng+1:ny+ng))
    ...
    ALLOCATE(iekbar(-ng+1:nx+ng,-ng+1:ny+ng))
  ...
  SUBROUTINE collisional_ionisation
    ...
    ALLOCATE(idens(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(jdens(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(e_dens(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(itemp(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(jtemp(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(e_temp(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(log_lambda(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(e_log_lambda(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(meanx(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(meany(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(meanz(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(part_count(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(iekbar(-ng+1:nx+ng,-ng+1:ny+ng))
    ALLOCATE(e_ekbar(-ng+1:nx+ng,-ng+1:ny+ng))
...
!    coll_freq = MAX(coll_freq, vrabs / (jdens**(1.0_num / 3.0_num)))
  ...
  PURE FUNCTION calc_coulomb_log(ekbar1, temp2, dens1, dens2, q1, q2, m1)
    ...
    REAL(num), DIMENSION(-ng+1:,-ng+1:), INTENT(IN) :: ekbar1, temp2
    REAL(num), DIMENSION(-ng+1:,-ng+1:), INTENT(IN) :: dens1, dens2
    REAL(num), INTENT(IN) :: q1, q2, m1
    REAL(num), DIMENSION(-ng+1:nx+ng,-ng+1:ny+ng) :: calc_coulomb_log
