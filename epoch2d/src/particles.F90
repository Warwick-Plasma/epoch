...
CONTAINS
  ...
  SUBROUTINE push_particles
    ...
    REAL(num), DIMENSION(sf_min-2:sf_max+1,sf_min-1:sf_max+1) :: jxh
    REAL(num), DIMENSION(sf_min-1:sf_max+1,sf_min-2:sf_max+1) :: jyh
    REAL(num), DIMENSION(sf_min-1:sf_max+1,sf_min-1:sf_max+1) :: jzh
