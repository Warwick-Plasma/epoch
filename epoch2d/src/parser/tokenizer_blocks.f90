...
CONTAINS
  ...
  FUNCTION as_constant(name)
    ...
    IF (str_cmp(name,"ev")) as_constant=CONST_EV
    IF (str_cmp(name,"kev")) as_constant=CONST_KEV
    IF (str_cmp(name,"mev")) as_constant=CONST_MEV
    IF (str_cmp(name,"x"))  as_constant=CONST_X
    IF (str_cmp(name,"y"))  as_constant=CONST_Y
    IF (str_cmp(name,"lengthx")) as_constant=CONST_LX
    IF (str_cmp(name,"lengthy")) as_constant=CONST_LY
    ...
    IF (str_cmp(name,"dir_pz")) as_constant=CONST_DIR_PZ
	 IF (str_cmp(name,"var")) as_constant=CONST_VAR
  ...
  FUNCTION as_function(name)
    ...
    IF (str_cmp(name,"gauss")) as_function=FUNC_GAUSS
	 IF (str_cmp(name,"semigauss")) as_function=FUNC_SEMIGAUSS
	 IF (str_cmp(name,"critical")) as_function=FUNC_CRIT
