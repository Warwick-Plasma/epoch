...
CONTAINS
  ...
  SUBROUTINE read_point_mesh_info_r4(h, npoints, geometry, extents, &
  ...
  SUBROUTINE read_srl_1d_pt_mesh_array_r4(h, x)
  ...
  END SUBROUTINE read_srl_1d_pt_mesh_array_r4



  SUBROUTINE read_srl_2d_pt_mesh_array_r4(h, x, y)
  ...
  END SUBROUTINE read_srl_2d_pt_mesh_array_r4



  SUBROUTINE read_srl_3d_pt_mesh_array_r4(h, x, y, z)
  ...
  END SUBROUTINE read_srl_3d_pt_mesh_array_r4



  SUBROUTINE read_point_mesh_r4(h, npoint_local, distribution, iterator, param)
    ...
    LOGICAL :: start
    REAL(r4), DIMENSION(:), ALLOCATABLE :: array
    REAL(r4) :: ret
    TYPE(sdf_block_type), POINTER :: b
  ...
  END SUBROUTINE read_point_mesh_r4



  ! Variable loading functions

  SUBROUTINE read_point_variable_info_r4(h, npoints, mesh_id, units, mult)
  ...
  END SUBROUTINE read_point_variable_info_r4



  SUBROUTINE read_point_variable_r4(h, npoint_local, distribution, iterator, &
      param)
  ...
  END SUBROUTINE read_point_variable_r4



  SUBROUTINE read_srl_pt_var_flt_array_r4(h, array)
  ...
  END SUBROUTINE read_srl_pt_var_flt_array_r4

END MODULE sdf_input_point_r4
