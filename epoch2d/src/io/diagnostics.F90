...
CONTAINS
  ...
  SUBROUTINE output_routines(i)   ! i = step index
    ...
    WRITE(filename_desc, '("(''nfs:'', a, ''/'', i", i3.3, ".", i3.3, "''.cfd'')")'), n_zeros, n_zeros
    ...
    IF (print_arrays) THEN
      ...
      IF (IAND(dumpmask(1), code) .NE. 0) CALL cfd_write_nd_particle_grid_with_iterator_all("Particles", "Part_Grid", iterate_particles, 2, npart_local, npart_dump_global, npart_per_it, c_particle_cartesian, subtype_particle_var)
      ...
      IF (IAND(dumpmask(3), code) .NE. 0) CALL cfd_write_nd_particle_variable_with_iterator_all("Px", "Particles" , iterate_px, npart_dump_global, n_part_per_it, "Particles", "Part_Grid", subtype_particle_var)
      IF (IAND(dumpmask(4), code) .NE. 0) CALL cfd_write_nd_particle_variable_with_iterator_all("Py", "Particles" , iterate_py, npart_dump_global, n_part_per_it, "Particles", "Part_Grid", subtype_particle_var)
      IF (IAND(dumpmask(5), code) .NE. 0) CALL cfd_write_nd_particle_variable_with_iterator_all("Pz", "Particles" , iterate_pz, npart_dump_global, n_part_per_it, "Particles", "Part_Grid", subtype_particle_var)
      IF (IAND(dumpmask(6), code) .NE. 0) CALL cfd_write_nd_particle_variable_with_iterator_all("Vx", "Particles" , iterate_vx, npart_dump_global, n_part_per_it, "Particles", "Part_Grid", subtype_particle_var)
      IF (IAND(dumpmask(7), code) .NE. 0) CALL cfd_write_nd_particle_variable_with_iterator_all("Vy", "Particles" , iterate_vy, npart_dump_global, n_part_per_it, "Particles", "Part_Grid", subtype_particle_var)
      IF (IAND(dumpmask(8), code) .NE. 0) CALL cfd_write_nd_particle_variable_with_iterator_all("Vz", "Particles" , iterate_vz, npart_dump_global, n_part_per_it, "Particles", "Part_Grid", subtype_particle_var)
#ifdef PART_DEBUG
      CALL cfd_write_nd_particle_variable_with_iterator_all("Processor", "Particles" , iterate_processor, npart_dump_global, n_part_per_it, "Particles", "Part_Grid", subtype_particle_var)
      CALL cfd_write_nd_particle_variable_with_iterator_all("Processor_at_t0", "Particles" , iterate_processor0, npart_dump_global, n_part_per_it, "Particles", "Part_Grid", subtype_particle_var)
#endif
      ...
      IF (IAND(dumpmask(9), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("Ex", "Electric Field", dims, stagger, "Grid" , "Grid", ex(1:nx, 1:ny), subtype_field)
      IF (IAND(dumpmask(10), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("Ey", "Electric Field", dims, stagger, "Grid" , "Grid", ey(1:nx, 1:ny), subtype_field)
      IF (IAND(dumpmask(11), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("Ez", "Electric Field", dims, stagger, "Grid" , "Grid", ez(1:nx, 1:ny), subtype_field)

      IF (IAND(dumpmask(12), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("Bx", "Magnetic Field", dims, stagger, "Grid" , "Grid", bx(1:nx, 1:ny), subtype_field)
      IF (IAND(dumpmask(13), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("By", "Magnetic Field", dims, stagger, "Grid" , "Grid", by(1:nx, 1:ny), subtype_field)
      IF (IAND(dumpmask(14), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("Bz", "Magnetic Field", dims, stagger, "Grid" , "Grid", bz(1:nx, 1:ny), subtype_field)

      IF (IAND(dumpmask(15), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("Jx", "Current", dims, stagger, "Grid", "Grid" , jx(1:nx, 1:ny), subtype_field)
      IF (IAND(dumpmask(16), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("Jy", "Current", dims, stagger, "Grid", "Grid" , jy(1:nx, 1:ny), subtype_field)
      IF (IAND(dumpmask(17), code) .NE. 0) CALL cfd_write_2d_cartesian_variable_parallel("Jz", "Current", dims, stagger, "Grid", "Grid" , jz(1:nx, 1:ny), subtype_field)
      ...
      IF (IAND(dumpmask(21), code) .NE. 0) THEN
        ...
        IF (IAND(dumpmask(21), c_io_no_intrinsic) .EQ. 0) CALL cfd_write_2d_cartesian_variable_parallel("Mass_Density", "Derived", dims, stagger, "Grid", "Grid", DATA(1:nx, 1:ny), subtype_field)
      ...
      IF (IAND(dumpmask(22), code) .NE. 0) THEN
        ...
        IF (IAND(dumpmask(22), c_io_no_intrinsic) .EQ. 0) CALL cfd_write_2d_cartesian_variable_parallel("Charge_Density", "Derived", dims, stagger, "Grid", "Grid", DATA(1:nx, 1:ny), subtype_field)
      ...
      IF (IAND(dumpmask(23), code) .NE. 0) THEN
        ...
        IF (IAND(dumpmask(23), c_io_no_intrinsic) .EQ. 0) CALL cfd_write_2d_cartesian_variable_parallel("Number_Density", "Derived", dims, stagger, "Grid", "Grid", DATA(1:nx, 1:ny), subtype_field)
  ...
  SUBROUTINE average_field(ioutput)
    ...
    SELECT CASE(ioutput)
    CASE (9)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + ex/REAL(count, num)
    CASE(10)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + ey/REAL(count, num)
    CASE(11)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + ez/REAL(count, num)
    CASE (12)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + bx/REAL(count, num)
    CASE(13)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + by/REAL(count, num)
    CASE(14)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + bz/REAL(count, num)
    CASE (15)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + jx/REAL(count, num)
    CASE(16)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + jy/REAL(count, num)
    CASE(17)
      averaged_data(ioutput)%data = averaged_data(ioutput)%data + jz/REAL(count, num)
