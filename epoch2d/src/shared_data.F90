...
MODULE shared_data
  ...
  INTEGER, PARAMETER :: c_subset_px_min     = 8
  INTEGER, PARAMETER :: c_subset_px_max     = 9
  INTEGER, PARAMETER :: c_subset_py_min     = 10
  INTEGER, PARAMETER :: c_subset_py_max     = 11
  INTEGER, PARAMETER :: c_subset_pz_min     = 12
  INTEGER, PARAMETER :: c_subset_pz_max     = 13
  INTEGER, PARAMETER :: c_subset_weight_min = 14
  INTEGER, PARAMETER :: c_subset_weight_max = 15
  INTEGER, PARAMETER :: c_subset_charge_min = 16
  INTEGER, PARAMETER :: c_subset_charge_max = 17
  INTEGER, PARAMETER :: c_subset_mass_min   = 18
  INTEGER, PARAMETER :: c_subset_mass_max   = 19
  INTEGER, PARAMETER :: c_subset_id_min     = 20
  INTEGER, PARAMETER :: c_subset_id_max     = 21
  INTEGER, PARAMETER :: c_subset_max        = 21
