...
#define PART_IONISE
  ...
  ! IO codes
  INTEGER, PARAMETER :: c_io_never = 0, c_io_always = 1, c_io_full = 2, c_io_restartable = 4, c_io_species = 8, c_io_averaged = 16
...
MODULE shared_parser_data
  ...
  INTEGER, PARAMETER :: c_const_dir_py = 53, c_const_dir_pz = 54, c_const_var = 55
  ...
  INTEGER, DIMENSION(num_ops), PARAMETER :: opcode_assoc = (/c_assoc_a, c_assoc_la, c_assoc_a, c_assoc_la, c_assoc_la, c_assoc_a, c_assoc_a, c_assoc_a, c_assoc_a, c_assoc_a, c_assoc_a, c_assoc_ra/)
...
MODULE shared_data
  ...
  INTEGER :: xbc_right_particle, xbc_left_particle , ybc_up_particle, ybc_down_particle
  INTEGER :: xbc_right_field, xbc_left_field , ybc_up_field, ybc_down_field
