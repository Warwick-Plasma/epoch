...
VAR_CARTESIAN=0; VAR_PARTICLE=1;
...
if type == VAR_CARTESIAN
    q = GetCartesianVariable(fid,length_block_metadata-12,length_block-12,ndims,sof);
elseif type == VAR_PARTICLE
    q = GetParticleVariable(fid,length_block_metadata-12,length_block-12,ndims,sof);
else
